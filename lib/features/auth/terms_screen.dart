    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text('Strut Terms & Conditions', style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold)),
            ...
            _bullet('Continued use of Strut services constitutes ongoing acceptance.', bodyStyle),
            ...
            _bullet('Strut reserves the right to suspend accounts for false or misleading information.', bodyStyle),
            const SizedBox(height: 16),

            // ── Section 4 ──
            Text('4. Personal Information & POPIA Compliance', style: headingStyle),
            const SizedBox(height: 8),
            _bullet('Strut processes personal information in accordance with the Protection of Personal Information Act (POPIA).', bodyStyle),
            ...
            const SizedBox(height: 8),
            _bullet('Strut implements technical and organisational safeguards (Section 19 POPIA).', bodyStyle),
            ...
            _bullet("Operators agree to deliver services in line with Strut's trade policy and industry standards.", bodyStyle),
            const SizedBox(height: 16),

            // ── Section 8 ──
            Text('8. Liability', style: headingStyle),
            const SizedBox(height: 8),
            _bullet('Strut is not liable for indirect losses but will take reasonable steps to ensure safe and secure transactions.', bodyStyle),
            const SizedBox(height: 16),

            // ── Section 9 ──
            Text('9. Termination', style: headingStyle),
            const SizedBox(height: 8),
            _bullet('Strut may suspend or terminate accounts for breach of these terms.', bodyStyle),
            ...
            const Divider(),
            const SizedBox(height: 16),
            Text('Strut Trade Policy', style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.bold)),
            const SizedBox(height: 20),
            ...
            const SizedBox(height: 8),
            _bullet("Payments are processed securely via Strut's platform.", bodyStyle),
            ...
            const SizedBox(height: 8),
            _bullet("Disputes will be handled through Strut's internal resolution process.", bodyStyle),
